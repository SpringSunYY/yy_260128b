<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="afterSalesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="orderId"/>
      <el-table-column label="商品" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible"
                       prop="goodsName"/>
      ...
      <el-table-column label="申请理由" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible"
                       prop="apply"/>
      ...
      <el-table-column label="审核人" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible"
                       prop="auditBy"/>
      ...
      <el-table-column label="审核原因" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible"
                       prop="auditDesc"/>

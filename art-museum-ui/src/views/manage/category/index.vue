  ...
  <div class="app-container">
    ...
    >
      <el-table-column label="名称" :show-overflow-tooltip="true" v-if="columns[0].visible" prop="name" />
        <el-table-column label="父级编号" align="center" :show-overflow-tooltip="true" v-if="columns[1].visible" prop="parentId" />
        <el-table-column label="祖级列表" align="center" :show-overflow-tooltip="true" v-if="columns[2].visible" prop="ancestors" />
        <el-table-column label="备注" align="center" :show-overflow-tooltip="true" v-if="columns[3].visible" prop="remark" />
        <el-table-column label="创建人" align="center" :show-overflow-tooltip="true" v-if="columns[4].visible" prop="userId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="父级编号" prop="parentId">
          <treeselect v-model="form.parentId" :options="categoryOptions" :normalizer="normalizer" placeholder="请选择父级编号" />
        </el-form-item>

  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="rechargeHistoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="审核人" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="auditBy" />
        <el-table-column label="审核时间" align="center" v-if="columns[6].visible" prop="auditTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.auditTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="审核原因" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="auditDesc" />
...
<script>
import { listRechargeHistory, getRechargeHistory, delRechargeHistory, addRechargeHistory, updateRechargeHistory } from "@/api/manage/rechargeHistory";

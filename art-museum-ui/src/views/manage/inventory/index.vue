    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择类型" clearable>
          <el-option
            v-for="dict in dict.type.inventory_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
...
export default {
  ...
  data() {
    return {
      ...
      form: {},
      // 导出地址
      exportUrl: 'manage/inventory/export',
      // 表单校验
      rules: {
        goodsId: [
  ...
  methods: {
    ...
    getList() {
      ...
      if (null != this.daterangeInventory && '' != this.daterangeInventory) {
        this.queryParams.params["beginInventory"] = this.daterangeInventory[0];
        this.queryParams.params["endInventory"] = this.daterangeInventory[1];
      }

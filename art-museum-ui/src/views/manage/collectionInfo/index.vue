<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="collectionInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="美术馆" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="galleryName"/>
      <el-table-column label="分类" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible"
                       prop="categoryName"/>
      <el-table-column label="名称" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="name"/>
      <el-table-column label="相关图片" align="center" v-if="columns[4].visible" prop="imageSrc" width="100">
      ...
      <el-table-column label="排序类型" align="center" v-if="columns[6].visible" prop="sortType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.collection_sort_type" :value="scope.row.sortType"/>
        </template>
      </el-table-column>
      <el-table-column label="作者" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible"
                       prop="author"/>
      <el-table-column label="年代" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="era"/>
      <el-table-column label="材质" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible"
                       prop="material"/>
      <el-table-column label="尺寸" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible"
                       prop="size"/>
      <el-table-column label="简介" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible"
                       prop="introduction"/>
      <el-table-column label="详细解读" :show-overflow-tooltip="true" align="center" v-if="columns[12].visible"
                       prop="detailedInterpretation"/>
      <el-table-column label="历史背景" :show-overflow-tooltip="true" align="center" v-if="columns[13].visible"
                       prop="historicalBackground"/>
      <el-table-column label="收藏数" :show-overflow-tooltip="true" align="center" v-if="columns[14].visible"
                       prop="collectNumber"/>
      ...
      <el-table-column label="创建人" :show-overflow-tooltip="true" align="center" v-if="columns[16].visible"
                       prop="userName"/>
      <el-table-column label="更新人" :show-overflow-tooltip="true" align="center" v-if="columns[17].visible"
                       prop="updateBy"/>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {key: 4, label: '相关图片', visible: true},
        {key: 5, label: '状态', visible: true},
        {key: 6, label: '排序类型', visible: true},
        {key: 7, label: '作者', visible: true},
        {key: 8, label: '年代', visible: true},
        {key: 9, label: '材质', visible: true},
        {key: 10, label: '尺寸', visible: true},
        {key: 11, label: '简介', visible: false},
        {key: 12, label: '详细解读', visible: true},
        {key: 13, label: '历史背景', visible: true},
        {key: 14, label: '收藏数', visible: true},

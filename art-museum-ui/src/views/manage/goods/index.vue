  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        <el-table-column label="关联藏品" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="collectionId" />
        <el-table-column label="名称" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="name" />
        <el-table-column label="价格" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="price" />
        <el-table-column label="销量" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="sales" />
        ...
        <el-table-column label="库存" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="inventory" />
        ...
        <el-table-column label="描述" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="description" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="关联藏品" prop="collectionId">
          <el-input v-model="form.collectionId" placeholder="请输入关联藏品" />
        </el-form-item>
        <el-form-item label="名称" prop="name">
